  ...
  return (
    ...
    <Box p="4rem 3rem 1rem" className="banner">
      ...
      <Typography fontWeight={500}>
        <Image src={circle} alt="circle" layout="responsive" className="img-circle" />
      ...
      <Grid container spacing={2} style={{ width: '70%' }}>
        {partnersCard.map((card, index) => (
          <Grid item xs={12} md={6} key={index}>
            <Paper elevation={3} style={{ padding: '20px 0', backgroundColor: 'transparent', border: 'none', boxShadow: 'none', margin: '0 auto' }}>
